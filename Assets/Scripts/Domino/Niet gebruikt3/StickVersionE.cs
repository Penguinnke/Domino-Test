...
public class StickVersionE : MonoBehaviour
{
    ...
    private void StickToSide()
    {
        ...
        float xOffset = GetComponent<BoxCollider2D>().bounds.extents.x + targetObject.GetComponent<BoxCollider2D>().bounds.extents.x;
